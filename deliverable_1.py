...
def option_a():
  ...
  print('''\nSplit-it is a Fair Grade Allocator that determines the grade of each individual to a group project. The purpose of the application is to help teams allocate the credit for a project so that all parties are satisfied with the outcome.\n''')
  return_to_menu()
